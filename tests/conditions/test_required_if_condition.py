...
class TestRequiredIfCondition(unittest.TestCase):
    ...
    def test_required_if_single_value(self) -> None:
        ...
        self.input_filter.validateData({"field1": "not value"})
    ...
    def test_required_if_list_of_values(self) -> None:
        ...
        self.input_filter.validateData({"field4": "value2"})
        self.input_filter.validateData({"field3": "value1", "field4": "value"})
        self.input_filter.validateData({"field3": "value2", "field4": "value"})
    ...
    def test_invalidates_when_required_field_missing_list_of_values(
        ...
        with self.assertRaises(ValidationError):
            self.input_filter.validateData({"field3": "value1"})
    ...
    def test_required_if_none_value(self) -> None:
        ...
        self.input_filter.validateData({"field6": "value"})
        self.input_filter.validateData(
    ...
    def test_invalidates_when_required_field_missing_none_value(self) -> None:
        ...
        with self.assertRaises(ValidationError):
            self.input_filter.validateData({"field5": "any_value"})
